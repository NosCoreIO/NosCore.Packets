...
namespace NosCore.Packets.ServerPackets.Inventory
{
    ...
    {
        [PacketIndex(0)] public long VisualId { get; set; }

        [PacketIndex(1)] public byte Visibility { get; set; }
        ...
        [PacketIndex(5)] public CharacterClassType ClassType { get; set; }

        [PacketIndex(6)] public InEquipmentSubPacket? EqSubPacket { get; set; }
