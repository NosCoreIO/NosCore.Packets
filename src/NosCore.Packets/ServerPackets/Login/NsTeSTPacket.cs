...
namespace NosCore.Packets.ServerPackets.Login
{
    ...
    public class NsTestPacket : PacketBase
    {
        ...
        [PacketIndex(1, IsOptional = true)] public int? Unknown { get; set; }

        [PacketIndex(2)] public int SessionId { get; set; }


        [PacketIndex(3)] public List<NsTeStSubPacket?>? SubPacket { get; set; }
    }
}