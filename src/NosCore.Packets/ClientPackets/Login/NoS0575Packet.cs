...
namespace NosCore.Packets.ClientPackets.Login
{
    ...
    {
        [PacketIndex(0)] public int SessionId { get; set; }

        [PacketIndex(1)] public string? Username { get; set; }

        [PacketIndex(2)] public string? Password { get; set; }

        [PacketIndex(3)] public Guid? ClientId { get; set; }
        ...
        [PacketIndex(4)] public ClientVersionSubPacket? ClientVersion { get; set; }

        [PacketIndex(5)] [Range(0, 0)] public byte UnknownConstant { get; set; }
