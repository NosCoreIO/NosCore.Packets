...
namespace NosCore.Packets.Enumerations
{
    ...
    public enum Game18NConstString : short
    {
       ...
       PlayerCanNotBeDismissed = 291,
        ...
        //YouHavePassedZenasSecondTestTheFinalTestWillSoonBegin = 2247,
        ...
        ErrICantDoThat = 2262,
        FernonsFollowersHaveAppeared = 2263,
        ...
        YouSucceededInEscapingFromTheLostCatacombsYouHaveReceivedBoxReward = 2338,
        ...
        TattooRemoved = 2440,
        TattooUpgraded = 2441,
        CantCarveAnyMoreRunesasItIsAlreadyTheHighestLevel = 2442,
